...
(function setConcurrentSocketLimit() {
  ...
  require("http").globalAgent.maxSockets = gconfig.maxReqOnSingleSocket;
  require("https").globalAgent.maxSockets = gconfig.maxReqOnSingleSocket;
})();
...
//TODO: collect different exit code of crawler process for different reasons
